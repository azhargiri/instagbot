...
instagram.username = 'bebekracing.id'
instagram.password = 'bebekracing28'
...
urlCollection = [
        "https://www.instagram.com/p/BzsK9HZgIYm/",
        "https://www.instagram.com/p/BzsQCJKhP-d/",
        "https://www.instagram.com/p/BzsCOoDhMMt/"
        ]
...
for url in urlCollection:
    ...
    while(n < max_liker_count):
        ...
        accountToFollow = liker.find_elements_by_css_selector('a')[0]
